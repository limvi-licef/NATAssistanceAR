...
# obj attribute is a dictionnary that associate an object name as key to its position as glm.vec2.
...
class BaseScenario2D:
    ...
    def Update(self, detection, frame):
        ...
        # set frame as attribute in order to make it accessible in child class
        self.frame = frame
        ...
        for n, obj in enumerate(detection["classes_names"]):
            ...
            x, y = detection["centers"][n] # position of the object
